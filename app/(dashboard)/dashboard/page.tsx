...
categories={[" ที่ผู้เล่นเข้ามาในหน้าเข้าสู่ระบบ", " ที่ผู้เล่นกดปุ่มเข้าสู่ระบบครั้งแรก"]}
/>
  ...
  categories={["Completed Male Player", "Completed Female Player?", "UnCompleted Male Player", "UnCompleted Female Player?"]}
  ...
  />
        <DailyTraffic
          ...
          categories={["Rank 1 Male กี่คน?", "Rank 5 Male กี่คน?", "Rank 1 Female กี่คน?", "Rank 5 Female กี่คน?"]}
        />
        {/* Check Table */}
        <div>
          {/* <CheckTable
          ...
          <PieChartCard2
            ...
            data={[23, 7, 70]}
            labels={["ประเภทชายใช้เวลาตอบสนอง 0.1 - 0.10 วินาทีกี่คน",
              "ประเภทชายที่ใช้เวลาตอบสนองช้ากว่า 0.10 วินาทีขึ้นไปกี่คน",
              "ประเภทชายที่ไม่สนใจเลยกี่คน"]}
            data2={[23, 7, 70]}
            labels2={["ประเภทหญิงใช้เวลาตอบสนอง 0.1 - 0.10 วินาทีกี่คน",
              "ประเภทหญิงใช้เวลาตอบสนองช้ากว่า 0.10 วินาทีขึ้นไปกี่คน",
              "ประเภทหญิงที่ไม่สนใจเลยกี่คน"]}
          />
        </div>
...
"เพศชายในประเภทที่ 2",
"เพศชายในประเภทที่ 3",
"เพศหญิงในประเภทที่ 1",
"เพศหญิงในประเภทที่ 2",
"เพศหญิงในประเภทที่ 3"
            ]}
          />
        </div>
        <div className="grid grid-cols-1 gap-5 rounded-[20px] md:grid-cols-1">
